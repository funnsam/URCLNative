...
pub fn gen_ast<'a>(toks: Vec<UToken<'a>>, src: Rc<str>) -> Parser<'a> {
    ...
    for el in p.ast.instructions.iter_mut() {
        *el = match el {
            ...
            Inst::SETC(d, a, b) => Inst::SETC(d.clone().transform_mem(ms), a.clone().transform_mem(ms), b.clone().transform_mem(ms)),
            Inst::SETNC(d, a, b) => Inst::SETNC(d.clone().transform_mem(ms), a.clone().transform_mem(ms), b.clone().transform_mem(ms)),
            ...
            Inst::BSL(d, a, b) => Inst::BSL(d.clone().transform_mem(ms), a.clone().transform_mem(ms), b.clone().transform_mem(ms)),
            Inst::BSR(d, a, b) => Inst::BSR(d.clone().transform_mem(ms), a.clone().transform_mem(ms), b.clone().transform_mem(ms)),
